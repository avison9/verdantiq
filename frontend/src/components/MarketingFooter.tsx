  ...
  <footer className="bg-gray-950 text-gray-400">
    <div className="max-w-7xl mx-auto px-6 pt-16 pb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-12">
        ...
        <div className="lg:col-span-2">
          ...
          <p className="mt-4 text-sm leading-relaxed max-w-xs">
            Enterprise-grade precision agriculture platform. Connect your sensors,
            automate your analytics, and grow smarter with AI-driven insights.
          </p>
      ...
      <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs">
        <p>© {CURRENT_YEAR} VerdantIQ, Inc. All rights reserved.</p>
        <p>
