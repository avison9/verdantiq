...
const StorageOverview = () => {
  usePageTitle("Storage Overview — VerdantIQ");
  ...
  return (
    <div className="px-6 py-8">
      <div className="mb-8 flex items-start justify-between">
        <div>
          <h1 className="text-lg font-semibold text-gray-800">Storage Overview</h1>
          <p className="text-sm text-gray-400 mt-0.5">Data volume and storage allocation for your IoT sensor network</p>
        </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        {["Storage Growth Over Time", "Allocation vs Usage"].map(title => (
          <div key={title} className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 flex flex-col items-center justify-center">
            ...
            <p className="text-xs text-gray-300 mt-1">MinIO + Iceberg integration coming soon</p>
          </div>
        ))}
      </div>
    </div>
